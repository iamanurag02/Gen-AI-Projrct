...
async function generateInterViewReportController(req, res) {
    ...
    console.log("Resume text length:", resumeContent.text ? resumeContent.text.length : 0);
    ...
    console.log("AI Result Keys:", Object.keys(interViewReportByAi));
...
async function deleteInterviewReportController(req, res) {
    ...
    res.status(200).json({
        ...
        interviewReportId: deletedReport._id
    })
}
